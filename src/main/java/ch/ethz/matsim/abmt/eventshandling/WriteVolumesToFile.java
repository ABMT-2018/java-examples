...
public class WriteVolumesToFile {
    ...
    public static void main(String... args) throws IOException {
        ...
        new MatsimNetworkReader(scenario.getNetwork()).readFile("path/to/output/output_network.xml.gz");
        ...
        // ".gz" extension
        BufferedWriter writer = IOUtils.getBufferedWriter("path/to/volumes.csv");
        ...
        new NetworkWriter(network).write("path/to/network_volumes.xml.gz");
    }
}
